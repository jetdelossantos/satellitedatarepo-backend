...
public class FileConstant {
    ...
    public static final String USER_FOLDER = System.getProperty("user.home") + "/satellitedata/user/";
    public static final String SATDATA_FOLDER = System.getProperty("user.home") + "/satellitedata/uploadfiles/";
